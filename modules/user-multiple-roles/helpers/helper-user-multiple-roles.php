 ...
 */
function aiowpu_get_roles() {

	global $wp_roles;
	return apply_filters( 'aiowpu_get_roles', $wp_roles->role_names );
 ...
 */
function aiowpu_get_editable_roles() {
	...
	return apply_filters( 'aiowpu_get_editable_roles', (array) $final_roles );
}
 ...
 * @return array Roles in name => label pairs.
 */
function aiowpu_get_user_roles( $user = 0 ) {
	...
	return apply_filters( 'aiowpu_get_user_roles', $roles );
}
 ...
 * @return bool
 */
function aiowpu_update_roles( $user_id = 0, $roles = array() ) {

	do_action( 'aiowpu_before_update_roles', $user_id, $roles );
	...
	do_action( 'aiowpu_after_update_roles', $user_id, $roles, $user->roles );
