jQuery(document).ready(function ($) {
	...
	function set_preview_image(image_id) {
		var data = {
				action: 'aiowpu_change_featured_image_preview',
				image_id: image_id,
				nonce: aiowpu_featured_image.aiowpufi_nonce,
			};
	...
	$set_button.click(function (e) {
		e.preventDefault();
		var frame = wp.media({
			title : aiowpu_featured_image.manager_title,
			multiple : false,
			library : { type : 'image' },
			button : { text : aiowpu_featured_image.manager_button }
		});
